...
* Your script must send a `POST` request with the contents of a file, passed with the filename as the second
* argument of the script, in the body of the request
* You have to use `curl`
