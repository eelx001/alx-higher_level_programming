...
The size of a square is crucial for a square, many things depend of it (area computation, etc.), so we, as class builder, must control the type and value of this attribute. One way to have the control is to keep it privately. we will see in next tasks how to get, update and validate the size value.
